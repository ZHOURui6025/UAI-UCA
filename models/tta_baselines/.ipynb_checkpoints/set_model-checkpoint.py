...
from models.tta_baselines.ctta import CTTA
from models.tta_baselines.ctta_untrain import CTTA_untrain
...
def set_model(model, optimizer, args, margin_e0=0):
    ...
    elif args.method=='ctta':
        model=CTTA(model, optimizer, steps=args.tta_steps)
    elif args.method=='ctta_untrain':
