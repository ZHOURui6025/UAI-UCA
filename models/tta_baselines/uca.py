...
def forward_and_adapt(modality_query, device, args, metric_logger, queue_list, max_queue_size, update_signal, step, model, optimizer):
    ...
    """
    # print('ablation')
    loss_REM, loss_UNI, loss_EMG, loss_CON, queue_list, outputs,target_modality_gap,confidence_gap,distances=model.module.forward_uca(modality_query, device, queue_list, max_queue_size, update_signal, step, args)
