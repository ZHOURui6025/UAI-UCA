...
for file in yaml_files:
    ...
    for i, line in enumerate(lines):
        if 'pretrained:' in line and line.strip() == "pretrained: './weights/model_base_retrieval_coco.pth'":
            lines[i] = "pretrained: './weights/model_large_retrieval_coco.pth'\n"

        if 'vit:' in line and line.strip() == "vit: 'base'":
            lines[i] = "vit: 'large'\n"

        if 'vit_ckpt_layer:' in line and line.strip() == "vit_ckpt_layer: 4":
            lines[i] = "vit_ckpt_layer: 12\n"
